...
export const WorksCard = ({
  ...
  return (
    ...
    >
      <div className="flex md:mx-auto w-full  lg:w-1/2 h-[300px] md:h-auto lg:h-[600px] rounded-lg overflow-hidden bg-slate-200">
      ...
      <div className="w-full md:w-full mx-auto lg:w-1/2 flex flex-col  justify-center lg:pr-10 gap-4 lg:gap-6">
        <h3
          className={`text-xl lg:text-3xl ${
            !reverseOrientation ? 'text-start' : 'text-end'
          }  text-blue-900 mdOnly:text-center leading-tight font-medium`}
        >
          {title}
        </h3>
        <div className="mdOnly:flex-col mdOnly:items-start mdOnly:justify-start mdOnly:gap-8">
          <p
            className={`text-md lg:text-xl  ${
              !reverseOrientation ? 'text-start' : 'text-end'
            }  mdOnly:text-center font-light`}
          >
            {text}
          </p>
          <div
            className={`flex flex-col sm:flex-row justify-center ${
              !reverseOrientation ? 'lg:justify-start' : 'lg:justify-end'
            } mt-4 mdOnly:mt-4 lg:mt-8`}
          >
            {buttonName && (
              <Link to={link}>
