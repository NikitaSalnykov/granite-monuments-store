...
export const Reviews = () => {
  ...
  return (
    <Section>
      ...
      <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 md:gap-4 lg:gap-12 px-2 lg:px-12 items-start">
...
<p className="text-gray-700 text-sm md:text-md font-semibold">
          ...
          <p className='text-black font-bold mb-2'>{el.title}</p>
