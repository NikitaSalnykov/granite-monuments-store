  ...
  return (
    <>
      <div>
        ...
        <div className=' text-gray-600 text-xs mt-2 font-manrope flex gap-2 justify-center'>
          <a target='_blank' className='hover:bg-gray-200' href="https://forms.gle/C1bGvtnXMfGjDJBg8">{t("leave_review")}</a>
        </div>
      </div>
    </>
  );
