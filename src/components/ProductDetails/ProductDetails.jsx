          ...
          <div>
            <div className="border-t border-b py-4 mt-7 border-gray-200">
              ...
              >
                ...
                >
                  <svg
                    className={`transform ${isShippingVisible ? 'rotate-180' : ''} text-gray-300 dark:text-white`}
                    width="10"
                    height="6"
                    viewBox="0 0 10 6"
                    fill="none"
              ...
              {isShippingVisible && (
                <p className="pt-4 text-base leading-normal pr-12 text-gray-600 dark:text-gray-300">
        ...
        <div>
          <div className="border-b py-4 border-gray-200">
            ...
            >
              ...
              >
                <svg
                  className={`transform ${isContactVisible ? 'rotate-180' : ''} text-gray-300 dark:text-white`}
                  width="10"
                  height="6"
                  viewBox="0 0 10 6"
                  fill="none"
