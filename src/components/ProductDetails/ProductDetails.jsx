      ...
      <div className="xl:w-2/5 lg:w-1/2 lg:ml-8 lg:mt-0 mt-6">
        <div className="border-b border-gray-400 pb-6">
          <div className="text-sm leading-none text-black flex gap-1">
            <div className=" cursor-pointer hover:opacity-70"><Link to={`/products?category=${category}`}>{t(category)} </Link></div>
            <div>/</div>
            <div className=" cursor-pointer hover:opacity-70"><Link to={`/products?category=${category}&type=${type}`}>{t(type)} </Link></div>
          </div>
        ...
        <div className="py-4 border-b border-gray-400 flex items-center justify-between">
          <p className="text-base leading-4 font-bold text-gray-800 "> {t('price')}</p>
          {
          discount && discount > 1 ? 
          (<div className='flex gap-2'>
            <p className='text-3xl text-red'>{resultPrice(price, discount)} грн</p>  
        ...
        <a href="tel:+380672037580" className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-base flex items-center justify-center leading-none text-white bg-gray-800 w-full py-4 hover:bg-gray-700 gap-2">
        ...
        <div>
          <div className="border-b py-4 border-gray-400">
            ...
            >
              <p className="text-base leading-4 text-gray-800 font-semibold"> {t('contact_us')}</p>
              <button
                className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 rounded"
                aria-label="show or hide"
              >
            ...
            {isContactVisible && (
              <div className="pt-4 text-base leading-normal pr-12 text-black ">
                <div className="md:hidden"><ContactList small column/></div>
                <div className="hidden md:block"><ContactList small/></div>
              </div>
            )}
          </div>
        </div>
