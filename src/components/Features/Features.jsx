  ...
  return (
    <Section>
      {/* <Container>
        ...
        <ul className="flex gap-8 md:gap-16 xl:gap-16 justify-center  items-start flex-wrap">
          <li className="md:w-[320px]">
            <div className="flex flex-col md:flex-col justify-center items-center gap-2 md:gap-1">
              <div className="flex flex-col justify-center items-center gap-2">
                <div className="md:hidden flex justify-center items-center p-2 rounded-xl w-[56px] h-[56px] bg-[#243642]">
                  <Svg id={'icon-quality'} size={26} stroke={'white'} fill={'white'} />
                </div>
                <div className="hidden md:flex justify-center items-center p-4 rounded-[50%] w-[56px] h-[56px] bg-[#243642]">
                  <Svg id={'icon-quality'} size={26} fill={'white'} />
                </div>
                <p className="text-lg md:text-xl font-bold text-center">
                  Висока якість
                </p>
              </div>
              <p className="text-lg text-start md:text-center text-secondaryText">
              Довговічність та стійкість матеріалів
              </p>
            </div>
          </li>
          <li className="md:w-[320px]">
            <div className="flex flex-col md:flex-col md:justify-center items-center gap-2 md:gap-1">
              <div className="flex flex-col justify-center items-center gap-2">
                <div className="p-2 rounded-xl flex justify-center items-center md:hidden w-[56px] h-[56px] bg-[#243642]">
                  <Svg id={'icon-clock'} size={26} fill={'transparent'} stroke={'white'}/>
                </div>
                <div className="hidden md:flex justify-center items-center p-4 rounded-[50%] w-[56px] h-[56px] bg-[#243642]">
                  <Svg id={'icon-clock'} size={26} fill={'transparent'} stroke={'white'}/>
                </div>
          ...
          <li className="md:w-[320px]">
            <div className="flex flex-col md:flex-col justify-center items-center gap-2 md:gap-1">
              <div className="flex flex-col justify-center items-center gap-2">
              <div className="p-2 rounded-xl flex justify-center items-center md:hidden w-[56px] h-[56px] bg-[#243642] ">
                  <Svg id={'icon-delivery'} size={26} fill={'white'} />
                </div>
                <div className="hidden md:flex justify-center items-center p-4 rounded-[50%] w-[56px] h-[56px] bg-[#243642]">
                  <Svg id={'icon-delivery'} size={26} fill={'white'} />
                </div>
              ...
              <p className="text-lg text-start md:text-center text-secondaryText">
                Повний сервіс від початку до кінця
              </p>
            </div>
          </li>
          <li className="hidden lg:block md:w-[320px]">
            <div className="flex flex-col md:flex-col justify-center items-center gap-2 md:gap-1">
              <div className="flex flex-col justify-center items-center gap-2">
              <div className="p-2 rounded-xl flex justify-center items-center md:hidden w-[56px] h-[56px] bg-[#243642] ">
                  <Svg id={'icon-delivery'} size={26} fill={'white'} />
