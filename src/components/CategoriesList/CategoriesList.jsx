      ...
      {categories && categories.length > 0 && (
        ...
        >
          {categories.map((el, index) => (
            <li key={index}>
              <Link to={`${el.link}`}>
                <div className="relative w-full h-[110px] md:h-[300px] lg:h-[280px] grayscale-[0%] hover:shadow-xl bg-slate-400 over:bg-opacity-60 transition cursor-pointer  rounded-lg overflow-hidden">
                  <img
